...
3. Run build_model.py to train and tune a binary Random Forest Classifier 
4. Run submit_scores.py to push the risk scores to CommCare HQ via the Submission API
